...
(1, 'wordpress', '@gingeds', 'https://profiles.wordpress.org/gingeds'),
(2, 'twitter', '@liam__stewart', 'https://twitter.com/liam__stewart'),
(3, 'briefcase', 'Ginge Digital', 'https://www.ginge.ca'),
(4, 'codepen', '/liamstewart23', 'http://codepen.io/liamstewart23/'),
(5, 'github', '/liamstewart23', 'https://github.com/liamstewart23/'),
(6, 'envelope', 'me@lstew.com', 'mailto:me@lstew.com'),
(7, 'bitbucket', '/lstewart2397', 'https://bitbucket.org/lstewart2397/'),
(8, 'linkedin', 'Liam Stewart', 'https://www.linkedin.com/in/liamstewart23/');
